                            ...
                            <div class="nk-header-brand">
                                <a href="index.html" class="logo-link"
                                    ><img
                                        ...
                                        srcset="
                                            /demo6/images/logo-dark2x.png 2x
                                        "
                                        alt="logo-dark"
                                /></a>
                            </div>
                            <div
                                class="nk-header-menu"
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-heading">
                                                <h6
                                                    class="overline-title text-primary"
                                                >
                                                    Use-Case Concept
                                                </h6>
                                            </li>
                                        ...
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item has-sub">
                                                ...
                                                <ul class="nk-menu-sub">
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/alerts.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Alerts</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/accordions.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Accordions</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/avatar.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Avatar</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/badges.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Badges</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/buttons.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Buttons</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/buttons-group.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Button
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/breadcrumb.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Breadcrumb</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/cards.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Cards</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/carousel.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Carousel</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/list-dropdown.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >List
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/modals.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Modals</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/pagination.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Pagination</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/popover.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Popovers</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/progress.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Progress</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/spinner.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Spinner</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/tabs.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Tabs</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/toast.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Toasts</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/tooltip.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Tooltip</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/typography.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Typography</span
                                            ...
                                            <li class="nk-menu-item has-sub">
                                                ...
                                                <ul class="nk-menu-sub">
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/util-border.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Border</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/util-colors.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Colors</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/util-flex.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Flex</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/util-text.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Text</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/util-sizing.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Sizing</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/elements/util-others.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Others</span
                                            ...
                                            <li class="nk-menu-item has-sub">
                                                ...
                                                <ul class="nk-menu-sub">
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/form-elements.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Form
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/checkbox-radio.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Checkbox
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/advanced-controls.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Advanced
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/input-group.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Input
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/form-upload.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Form
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/datetime-picker.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Date &amp; Time
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/number-spinner.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Number
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/nouislider.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >noUiSlider</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/form-layouts.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Form
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/form-validation.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Form
                                                    ...
                                                    <li class="nk-menu-item">
                                                        ...
                                                        <ul class="nk-menu-sub">
                                                            ...
                                                            >
                                                                <a
                                                                    href="components/forms/form-wizard.html"
                                                                    class="nk-menu-link"
                                                                    ><span
                                                                        class="nk-menu-text"
                                                                        >Basic
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/form-quill.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Quill</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/forms/form-tinymce.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Tinymce</span
                                            ...
                                            <li class="nk-menu-item has-sub">
                                                ...
                                                <ul class="nk-menu-sub">
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/misc/svg-icons.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >SVG Icon -
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/misc/nioicon.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Nioicon -
                                            ...
                                            <li class="nk-menu-item">
                                                <a
                                                    href="components/misc/icons.html"
                                                    class="nk-menu-link"
                                                    ><span class="nk-menu-text"
                                                        >Icon Libraries</span
                                                    ></a
                                            ...
                                            <li class="nk-menu-item has-sub">
                                                ...
                                                <ul class="nk-menu-sub">
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/tables/table-basic.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Basic
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/tables/table-special.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Special
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/tables/table-datatable.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >DataTables</span
                                            ...
                                            <li class="nk-menu-item has-sub">
                                                ...
                                                <ul class="nk-menu-sub">
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/charts/chartjs.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Chart JS</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/charts/knob.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Knob JS</span
                                            ...
                                            <li class="nk-menu-item has-sub">
                                                ...
                                                <ul class="nk-menu-sub">
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/widgets/cards.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Card
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/widgets/ratings.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Ratings</span
                                            ...
                                            <li class="nk-menu-item has-sub">
                                                ...
                                                <ul class="nk-menu-sub">
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/misc/slick-sliders.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Slick
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/misc/toastr.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Toastr</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/misc/sweet-alert.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Sweet
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/misc/js-tree.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >jsTree</span
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/misc/dual-listbox.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Dual
                                                    ...
                                                    <li class="nk-menu-item">
                                                        <a
                                                            href="components/misc/dragula.html"
                                                            class="nk-menu-link"
                                                            ><span
                                                                class="nk-menu-text"
                                                                >Dragula</span
                                ...
                                <ul class="nk-quick-nav">
                                    <li class="dropdown notification-dropdown">
                                        <a
                                            ...
                                            ><div
                                                class="icon-status icon-status-info"
                                            >
                                                <em
                                                    class="icon ni ni-bell"
                                                ></em></div
                                        ></a>
                                        <div
                                        ...
                                        >
                                            <div class="dropdown-head">
                                                <span
                                                    class="sub-title nk-dropdown-title"
                                                    >Notifications</span
                                                ><a href="#"
                                                    >Mark All as Read</a
                                                >
                                    ...
                                    <li
                                        class="dropdown user-dropdown order-sm-first"
                                    >
                                        <a
                                            href="#"
                                            ...
                                            ><div class="user-toggle">
                                                ...
                                                <div
                                                    class="user-info d-none d-xl-block"
                                                >
                                    ...
                                    <li
                                        class="dropdown language-dropdown d-none d-sm-flex me-n1"
                                    >
                                        <a
                                            href="#"
                                            class="dropdown-toggle nk-quick-nav-icon"
                    ...
                    <a href="https://dashlite.net/demo1/index.html"
                        ><div class="nk-demo-image bg-blue">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-1d2x.jpg 2x
                                "
                                alt="Demo Layout 1"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 1</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    <a href="https://dashlite.net/demo2/index.html"
                        ><div class="nk-demo-image bg-purple">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-2d2x.jpg 2x
                                "
                                alt="Demo Layout 2"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 2</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    <a href="https://dashlite.net/demo3/index.html"
                        ><div class="nk-demo-image bg-success">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-3d2x.jpg 2x
                                "
                                alt="Demo Layout 3"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 3</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    <a href="https://dashlite.net/demo4/index.html"
                        ><div class="nk-demo-image bg-indigo">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-4d2x.jpg 2x
                                "
                                alt="Demo Layout 4"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 4</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    <a href="https://dashlite.net/demo5/index.html"
                        ><div class="nk-demo-image bg-orange">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-5d2x.jpg 2x
                                "
                                alt="Demo Layout 5"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 5</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    <a href="index.html"
                        ><div class="nk-demo-image bg-purple">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-6d2x.jpg 2x
                                "
                                alt="Demo Layout 6"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 6</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    <a href="https://dashlite.net/demo7/index.html"
                        ><div class="nk-demo-image bg-teal">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-7d2x.jpg 2x
                                "
                                alt="Demo Layout 7"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 7</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    <a href="https://dashlite.net/demo8/index.html"
                        ><div class="nk-demo-image bg-azure">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-8d2x.jpg 2x
                                "
                                alt="Demo Layout 8"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 8</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    <a href="https://dashlite.net/demo9/index.html"
                        ><div class="nk-demo-image bg-pink">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/layout-9d2x.jpg 2x
                                "
                                alt="Demo Layout 9"
                            />
                        </div>
                        <span class="nk-demo-title"
                            ><strong>Demo Layout 9</strong></span
                        ></a
                    >
                </div>
                <div class="nk-demo-item">
                    ...
                    <a href="https://dashlite.net/demo5/loan/index.html"
                        ><div class="nk-demo-image bg-purple">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/demo-loan2x.jpg 2x
                                "
                                alt="loan"
                            />
                        </div>
                    ...
                    <a href="https://dashlite.net/demo2/lms/index.html"
                        ><div class="nk-demo-image bg-danger">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/demo-lms2x.jpg 2x
                                "
                                alt="LMS"
                            />
                        </div>
                    ...
                    <a href="https://dashlite.net/demo1/crm/index.html"
                        ><div class="nk-demo-image bg-info">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/demo-crm2x.jpg 2x
                                "
                    ...
                    <a href="https://dashlite.net/demo1/hotel/index.html"
                        ><div class="nk-demo-image bg-pink">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/demo-hotel2x.jpg 2x
                                "
                                alt="Hotel Managemen"
                            />
                        </div>
                    ...
                    <a href="https://dashlite.net/demo3/cms/index.html"
                        ><div class="nk-demo-image bg-dark">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/demo-cms2x.jpg 2x
                                "
                                alt="cms"
                            />
                        </div>
                    ...
                    <a href="https://dashlite.net/demo3/apps/mailbox.html"
                        ><div class="nk-demo-image bg-purple">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/demo-inbox2x.jpg 2x
                                "
                                alt="Inbox"
                            />
                        </div>
                    ...
                    <a href="https://dashlite.net/demo3/apps/chats.html"
                        ><div class="nk-demo-image bg-purple">
                            <img
                                ...
                                srcset="
                                    https://dashlite.net/images/landing/demo-chats2x.jpg 2x
                                "
                                alt="Chats / Messenger"
                            />
                        </div>
            ...
            <div class="nk-opt-panel" data-simplebar>
                ...
                <div class="nk-opt-set nk-opt-set-skin">
                    ...
                    <div class="nk-opt-list">
                        ...
                        >
                            <span class="nk-opt-item-bg"
                                ><span class="skin-blue"></span></span
        ...
        <div class="pmo-lv pmo-dark">
            ...
            ><a
                ...
                ><div class="pmo-text text-white">
                    Looking for functional script for HYIP Investment Platform?
                    Check out <em class="ni ni-arrow-long-right"></em></div
            ></a>
        </div>
        <a
            ...
            ><div class="pmo-st-img">
                <img
                    src="../images/landing/promo-investorm.png"
                    alt="Investorm"
                />
            </div>
